...
public class Main {
    public static void main(String[] args) {
         ...
         */
        System.out.println("El siguente programa ordenara los numeros generados de menor a mayor.");
        System.out.println("Digite la cantidad de números reales para el arreglo que se desea ordenar:");
        x = read.nextInt();
